      ...
      <Grid
        ...
        sx={{
          ...
          <Grid item xs={12} m={"2rem 1rem"} textAlign="center">
            <Typography variant="subtitle1" color={"rgb(116, 116, 116)"} fontWeight={"bold"}>آدرس انتخاب شده تحت پوشش دیجی‌واش نیست.</Typography>
          </Grid>
          <Grid container sx={{borderTop:"1px solid rgb(204, 204, 204)" ,p:"1rem 0",borderRadius:"16px 16px 0 0"}}>
